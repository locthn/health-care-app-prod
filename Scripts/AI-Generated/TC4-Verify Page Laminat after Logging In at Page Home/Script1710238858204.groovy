...
"Step 3: Click on link  -> Navigate to page 'laminat'"
...
"Step 9: Click on link  -> Navigate to page 'laminat/*'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Verify Page Laminat after Logging In at Page Home_visual_checkpoint')
