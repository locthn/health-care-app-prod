...
"Step 3: Click on link 'zur n\xe4chsten Seite'"
...
"Step 4: Click on div  -> Navigate to page 'Bestseller'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC12-Verify Page Bestseller after Logging in at Page Home_visual_checkpoint')
